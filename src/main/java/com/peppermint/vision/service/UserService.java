package com.peppermint.vision.service;
...
import com.peppermint.vision.persistence.repository.UsersettingsRepository;
...
public class UserService implements UserDetailsService {
  ...
  public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
    ...
    com.peppermint.vision.rest.dto.User user =
        modelMapper.map(userEntity, com.peppermint.vision.rest.dto.User.class);
    user.setRoles(
